    ...
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li class="treeview"><a href="#"><i class="fa fa-address-book-o fa-fw"></i> Product <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                    <ul class="treeview-menu">
                        {{--Menu Province--}}
                        <li class="treeview"><a href="#"><i class="fa fa-map-marker fa-fw"></i> Category <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                            <ul class="treeview-menu">
                        ...
                        {{--Menu Distric--}}
                        <li class="treeview"><a href="#"><i class="fa fa-map-pin fa-fw"></i> Prodcut List <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                            <ul class="treeview-menu">
                ...
                <li class="treeview"><a href="#"><i class="fa fa-address-book-o fa-fw"></i> Customer <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                    <ul class="treeview-menu">
                        {{--Menu Province--}}
                        <li class="treeview"><a href="#"><i class="fa fa-map-marker fa-fw"></i> Channel <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                            <ul class="treeview-menu">
                        ...
                        {{--Menu Distric--}}
                        <li class="treeview"><a href="#"><i class="fa fa-map-pin fa-fw"></i> Customer List <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span></a>
                            <ul class="treeview-menu">
